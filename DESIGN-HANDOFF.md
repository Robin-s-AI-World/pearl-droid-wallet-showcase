# fa4be8e4-9578-4dc2-babe-b88a1b6403b3 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `app-showcase-12s.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `app-showcase-12s.html`
...
- A single self-contained `app-showcase-12s.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `app-showcase-12s.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `app-showcase-12s.html`
- `mqm60tpg-claude-pearl-wallet-intro-19jun2026.html`
...
- `mqg00jmp-1-splash.png`
- `mqg00jna-2-wallet-home.png`
- `mqg00jok-4-otc-market.png`
- `mqgomji5-image.png`
- `mqgpeljk-1-splash.png`
- `mqgpvfye-pearlogo.png`
- `mqgq349z-image.png`
- `mqgq3kp6-image.png`
- `mqgq44w4-image.png`
- `mqgq54io-image.png`
...
1. Inspect `app-showcase-12s.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
